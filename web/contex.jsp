...
<center>
    ...
    <form method="POST" action="inside.jsp" onsubmit="return validateTime();">
    <br><br><b>Please Enter the YourID , Role and Client </b><BR><br>
                    <table> <tr><td>  <b>  User ID</b>   </td><td>       <input type="text"id="userid" name="userid" size="30" style="border-style: ridge; border-width: 1" ></td></tr><tr></tr><tr></tr><tr></tr><tr></tr>
        <tr><td> <b> Role    </b> </td>        <td><input type="text" id="role"name="role" size="30" style="border-style: ridge; border-width: 1" ></td></tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
        <tr><td>  <b> Application  </b>   </td><td>        <input type="text"id="client" name="client" size="30" style="border-style: ridge; border-width: 1" ></td></tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
        <tr><td>  <b>  Password  </b> </td><td><input type="password" id="password"name="password" size="30" style="border-style: ridge; border-width: 1" ></td></tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
        <tr></tr><tr></tr><tr></tr><tr><td> <input type="hidden" name="Query" value="<%= session.getAttribute("Query") %>" /></td></tr><tr></tr><tr></tr><tr></tr><tr></tr>

  </table>
            &nbsp;&nbsp; <input type="submit" value="       Login        " tabindex="3" name="command">
