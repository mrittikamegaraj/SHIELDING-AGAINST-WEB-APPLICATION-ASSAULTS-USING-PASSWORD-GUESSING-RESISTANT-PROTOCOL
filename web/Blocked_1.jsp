...
<div id="templatemo_wrapper">    
    ...
    <div id="templatemo_content">
    	<div id="templatemo_main_content"  style="height: 500px">
           ...
           <div style="overflow: auto;height: 300px;width: 450px"> 
                             <table border="1">
                                 <thead>BLOCKED USERS</thead>
		<%
			 try {
                String qry="SELECT * FROM user where status=1";
DB db= new DB();
              ResultSet  rs = db.Select(qry);
               while(rs.next())
                  ...
                  <tr>
                      ...
                      <td><%=rs.getString(1)%></td><td><a href="block.jsp?id=<%=rs.getString(1)%>">Block</a></td>
                  </tr>
