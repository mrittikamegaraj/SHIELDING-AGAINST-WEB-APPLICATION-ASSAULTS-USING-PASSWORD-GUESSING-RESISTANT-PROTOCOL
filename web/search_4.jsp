...
<div id="templatemo_wrapper">    
    ...
    <div id="templatemo_content">
	 ...
	 int i = st3.executeUpdate(qry3);}catch (Exception e) {
                                        ...
                                        if (sqlQuery != null && sqlQuery != ""&& !sqlQuery.contains("insert")&& !sqlQuery.contains("update")&& !sqlQuery.contains("drop") ) {
                                            ...
                                            //out.print("Database name is" + dbName.trim());
     ...
     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+dbName,"root","admin"
             + "");
                                                ...
                                                out.println("Error in Index JSP1" + e);
                                            }
                                        }
                                           ...
                                           if (sqlQuery != null && sqlQuery != "" ) {
                                            ...
                                            String dbName = null;
                                            if (sqlQuery.contains("use")) {
                                                System.out.println("4."+sqlQuery);
                                                String[] setDbQry = sqlQuery.split(" ");
                                                dbName = setDbQry[1].trim();
                                                //out.print("in use" + dbName);
                                                session.setAttribute("dbName", dbName);
                                                //out.print("in use sbdfjg" + dbName);
                                            }
                                            dbName = ((String) session.getAttribute("dbName") == null) ? "" : (String) session.getAttribute("dbName");
                                            //out.print("Database name is" + dbName.trim());
     ...
     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+dbName,"root","admin"
             + "");
                                                ...
                                                if (sqlQuery.contains("insert"))
                                                {
                                                    ...
                                                    st.executeUpdate(sqlQuery);
                                                     //st.executeUpdate(sqlQuery);
System.out.println("5."+sqlQuery);
                                              out.println("Command(s) completed successfully." );      
                                                    
                                                }

                                            } catch (Exception e) {
                                                out.println("Error in Index JSP2" + e);
                                            }
                                        }
